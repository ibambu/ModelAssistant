----bd_gddd租户脚本----
DROP TABLE IF EXISTS NG3.TR_NB_GPRS_FLUX_MARKET_INSTRUCT_PRDCT;
CREATE EXTERNAL TABLE NG3.TR_NB_GPRS_FLUX_MARKET_INSTRUCT_PRDCT (
...
DROP TABLE IF EXISTS NG3.TR_BASS_USR_STS;
CREATE EXTERNAL TABLE NG3.TR_BASS_USR_STS (
   USR_STS_CD    STRING,
   USR_STS_NAM    STRING,
   STS_PRIORITY    INT
)
...
ALTER TABLE NG3.TR_BASS_USR_STS ADD PARTITION (branch='GMCC');

DROP TABLE IF EXISTS NG3.TR_BASS_OPRTORINFO;
CREATE EXTERNAL TABLE NG3.TR_BASS_OPRTORINFO (
   OPR_ID    STRING,
   AREA_CD    STRING,
   OPR_NAM    STRING,
   BIRTHDAY    INT,
...
DROP TABLE IF EXISTS NG3.TR_BILL_ACCT;
CREATE EXTERNAL TABLE NG3.TR_BILL_ACCT (
   BILL_ACCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_SJDCRM_DICT_ITEM;
CREATE EXTERNAL TABLE NG3.TR_SJDCRM_DICT_ITEM (
   DICT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_BUSI_DAY;
CREATE EXTERNAL TABLE NG3.TW_CORP_BUSI_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   USR_NBR    STRING,
   B_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_APN_USR_DAY;
CREATE EXTERNAL TABLE NG3.TW_APN_USR_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   USR_NBR    STRING,
   APN_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TR_EBOX_ACCT_TYP;
CREATE EXTERNAL TABLE NG3.TR_EBOX_ACCT_TYP (
   EBOX_UNIT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_WEB_CHL_BUSI;
CREATE EXTERNAL TABLE NG3.TR_WEB_CHL_BUSI (
   BUSI_CD    STRING,
   BUSI_NAM    STRING
)
PARTITIONED BY (branch STRING)
...
DROP TABLE IF EXISTS NG3.TR_MMPLN_AP;
CREATE EXTERNAL TABLE NG3.TR_MMPLN_AP (
   AP_CD    STRING,
   AP_NAME    STRING,
   AP_KIND1    STRING,
   AP_KIND2    STRING,
...
DROP TABLE IF EXISTS NG3.TR_MOBGAME_BUSI_INF;
CREATE EXTERNAL TABLE NG3.TR_MOBGAME_BUSI_INF (
   BUSI_CD    STRING,
   TM_INTRVL_CD    INT,
   BUSI_NAME    STRING,
   SP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_SJDCRM_BASS_PRDCT;
CREATE EXTERNAL TABLE NG3.TR_SJDCRM_BASS_PRDCT (
...
DROP TABLE IF EXISTS NG3.TR_SJDCRM_OPR_ROLE_INF;
CREATE EXTERNAL TABLE NG3.TR_SJDCRM_OPR_ROLE_INF (
   OPR_ID    STRING,
   ROLE_ID    STRING,
   STATUS    STRING,
   STATUS_DT    INT,
...
DROP TABLE IF EXISTS NG3.TR_BASS_GOODS_DATA;
CREATE EXTERNAL TABLE NG3.TR_BASS_GOODS_DATA (
   GOODS_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_DICT_ITEM;
CREATE EXTERNAL TABLE NG3.TR_DICT_ITEM (
   DICT_CD    STRING,
   DICT_GROUP_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   DICT_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TR_CTMS_TRML_PRDCT;
CREATE EXTERNAL TABLE NG3.TR_CTMS_TRML_PRDCT (
...
DROP TABLE IF EXISTS NG3.TR_AUTO_OPRRSLT;
CREATE EXTERNAL TABLE NG3.TR_AUTO_OPRRSLT (
...
DROP TABLE IF EXISTS NG3.TM_MRKT_MNTR_10086_ITEM_DATA_DAY;
CREATE EXTERNAL TABLE NG3.TM_MRKT_MNTR_10086_ITEM_DATA_DAY (
   TM_INTRVL_CD    INT,
   REGION_CD    STRING,
   BRND_CD    SMALLINT,
   USR_GRADE    STRING,
...
DROP TABLE IF EXISTS NG3.TM_PERS_FAM_PAY_USR_D;
CREATE EXTERNAL TABLE NG3.TM_PERS_FAM_PAY_USR_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   TYP1_USR_CNT    INT,
   TYP2_USR_CNT    INT,
...
DROP TABLE IF EXISTS NG3.TM_ZNTS_SCESMS_ONTIM_DAY;
CREATE EXTERNAL TABLE NG3.TM_ZNTS_SCESMS_ONTIM_DAY (
   TM_INTRVL_CD    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   SR_TYP_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TM_ZNTS_CMPLN_INTIM_DAY;
CREATE EXTERNAL TABLE NG3.TM_ZNTS_CMPLN_INTIM_DAY (
   TM_INTRVL_CD    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   SR_TYP_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NB_CPRINT_BUSI_D;
CREATE EXTERNAL TABLE NG3.TM_NB_CPRINT_BUSI_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   USR_TYP    STRING,
...
DROP TABLE IF EXISTS NG3.TM_139_MAIL_USR_AGGR_DAY;
CREATE EXTERNAL TABLE NG3.TM_139_MAIL_USR_AGGR_DAY (
   TM_INTRVL_CD    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   REACH_USRCNT    INT,
...
DROP TABLE IF EXISTS NG3.TM_CALL_CMPT_BUSI_DAY;
CREATE EXTERNAL TABLE NG3.TM_CALL_CMPT_BUSI_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_SECUR_USR_DAY;
CREATE EXTERNAL TABLE NG3.TM_SECUR_USR_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TS_BIXF_CMNCT_USR;
CREATE EXTERNAL TABLE NG3.TS_BIXF_CMNCT_USR (
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_BIXF_MM_BUSI_DAY;
CREATE EXTERNAL TABLE NG3.TW_BIXF_MM_BUSI_DAY (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_BIXF_MOBBUSI_DAY;
CREATE EXTERNAL TABLE NG3.TW_BIXF_MOBBUSI_DAY (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TS_BIXF_JXCX_CUST_DAY;
CREATE EXTERNAL TABLE NG3.TS_BIXF_JXCX_CUST_DAY (
   TM_INTRVL_CD    INT,
   CUST_ID    STRING,
   CMCC_BRANCH_CD    STRING,
   GDR_TYP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_SJDCRM_BASS_GOODS_DATA;
CREATE EXTERNAL TABLE NG3.TR_SJDCRM_BASS_GOODS_DATA (
   GOODS_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   GOODS_PRICE    DECIMAL(14,2),
   GOODS_CLASS_CD    INT,
...
DROP TABLE IF EXISTS NG3.TR_RHJF_HSC_MINCONSUME_DAY;
CREATE EXTERNAL TABLE NG3.TR_RHJF_HSC_MINCONSUME_DAY (
   TARIFF_ID    STRING,
   CONSUME_ID    STRING,
   EFF_INTERVAL    INT,
   SPE_FEE    STRING,
...
DROP TABLE IF EXISTS NG3.TM_CMNCTUSR_DAY;
CREATE EXTERNAL TABLE NG3.TM_CMNCTUSR_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   TOWN_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_RHJF_HSC_PS_RATINGEBOX;
CREATE EXTERNAL TABLE NG3.TR_RHJF_HSC_PS_RATINGEBOX (
   TARIFF_ID    STRING,
   BOSS_DISC_CD    STRING,
   EBOX_UNIT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_MRKT_AIR_PAY_CNTY_DAY;
CREATE EXTERNAL TABLE NG3.TM_MRKT_AIR_PAY_CNTY_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_MRKT_AIR_PAY_RECORD_DAY;
CREATE EXTERNAL TABLE NG3.TM_MRKT_AIR_PAY_RECORD_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   FY_FEE    DECIMAL(14,2),
   HC_FEE    DECIMAL(14,2),
...
DROP TABLE IF EXISTS NG3.TR_TERM_MIFI_CARD_TAC_D;
CREATE EXTERNAL TABLE NG3.TR_TERM_MIFI_CARD_TAC_D (
   STAT_DT    INT,
...
DROP TABLE IF EXISTS NG3.TR_CELL;
CREATE EXTERNAL TABLE NG3.TR_CELL (
   LOCAL_CD    STRING,
   CELL_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   DISTICT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_DAY;
CREATE EXTERNAL TABLE NG3.TR_DAY (
   TM_INTRVL_CD    INT,
   DAY_CD    SMALLINT,
   WK_CD    SMALLINT,
   MO_CD    SMALLINT,
...
ALTER TABLE NG3.TR_DAY ADD PARTITION (branch='GMCC');

DROP TABLE IF EXISTS NG3.TM_MOB_STOCK;
CREATE EXTERNAL TABLE NG3.TM_MOB_STOCK (
   CMCC_BRANCH_CD    STRING,
   DATA_DATE    INT,
   CHNL_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TM_AOASETL_FIX_MOB_DAY;
CREATE EXTERNAL TABLE NG3.TM_AOASETL_FIX_MOB_DAY (
   CMCC_BRANCH_CD    STRING,
   SWITCH_NBR    STRING,
   OPER_IND    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_NB_GPRS_GGSN_D;
CREATE EXTERNAL TABLE NG3.TM_NB_GPRS_GGSN_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_MRKT_CHNL_AUDIT_PAY_DAY;
CREATE EXTERNAL TABLE NG3.TM_MRKT_CHNL_AUDIT_PAY_DAY (
   PAY_BILL_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   PAY_CHNL_CD    STRING,
   CHNL_BUSI_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TM_MRKT_CHNL_AUDIT_REC_FACT_DAY;
CREATE EXTERNAL TABLE NG3.TM_MRKT_CHNL_AUDIT_REC_FACT_DAY (
   CMCC_BRANCH_CD    STRING,
   CHNL_CD    STRING,
   BUSI_DT    INT,
   CHARGE_TYP    STRING,
...
DROP TABLE IF EXISTS NG3.TM_MRKT_CHNL_AUDIT_AG_DAY;
CREATE EXTERNAL TABLE NG3.TM_MRKT_CHNL_AUDIT_AG_DAY (
   CHNL_CD    STRING,
   BUSI_DT    INT,
   CHARGE_TYP    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_MRKT_CHNL_AUDIT_ET_DAY;
CREATE EXTERNAL TABLE NG3.TM_MRKT_CHNL_AUDIT_ET_DAY (
   CHNL_CD    STRING,
   BUSI_DT    INT,
   CHARGE_TYP    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NB_CNTN_GPRS_ITEM_D;
CREATE EXTERNAL TABLE NG3.TM_NB_CNTN_GPRS_ITEM_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   ITEM_CD    STRING,
   ITEM_VAL    BIGINT
...
DROP TABLE IF EXISTS NG3.TO_SCANCDR_PROC_REG;
CREATE EXTERNAL TABLE NG3.TO_SCANCDR_PROC_REG (
   PROC_NAM    STRING,
   REQ_ID    STRING,
   DESCR    STRING
)
...
DROP TABLE IF EXISTS NG3.TO_SHELL_LOG;
CREATE EXTERNAL TABLE NG3.TO_SHELL_LOG (
   OPR_TM    STRING,
   USER_ID    STRING,
   OPR_TYP_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_NEWBUSI_USR_DAY;
CREATE EXTERNAL TABLE NG3.TM_NEWBUSI_USR_DAY (
   DEBET_DT    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_BIXF_NET_CELL_CDR_BUSI_DAY;
CREATE EXTERNAL TABLE NG3.TW_BIXF_NET_CELL_CDR_BUSI_DAY (
   TM_INTRVL_CD    INT,
   HR_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   LOCAL_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_CALLBUSI_STAT_DAY;
CREATE EXTERNAL TABLE NG3.TM_CALLBUSI_STAT_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_GMCC_3G_BUSI_MO_TMP_DAY;
CREATE EXTERNAL TABLE NG3.TM_GMCC_3G_BUSI_MO_TMP_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_HR_CMNCT_DAY;
CREATE EXTERNAL TABLE NG3.TM_HR_CMNCT_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TS_SJDCRM_CORP_MEMB_MARK_PLAN_IDAY;
CREATE EXTERNAL TABLE NG3.TS_SJDCRM_CORP_MEMB_MARK_PLAN_IDAY (
   AREA_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_BOSS_BALTRAN_RPT_DAY;
CREATE EXTERNAL TABLE NG3.TM_BOSS_BALTRAN_RPT_DAY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   OSS_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TR_BASS_MARK_PLAN_RELA;
CREATE EXTERNAL TABLE NG3.TR_BASS_MARK_PLAN_RELA (
   OBJ_TYP    STRING,
   MARK_PLAN_CD    STRING,
   AREA_CD    STRING,
   RLT_OBJ_TYP    STRING,
...
DROP TABLE IF EXISTS NG3.TO_P_VIRTL_CORP_USR_D;
CREATE EXTERNAL TABLE NG3.TO_P_VIRTL_CORP_USR_D (
   GUSR_ID    STRING,
   GCUST_ID    STRING,
   GROUP_ID    STRING,
   GUSR_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_OTH_D;
CREATE EXTERNAL TABLE NG3.TM_OTH_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   ITEM_CD    STRING,
