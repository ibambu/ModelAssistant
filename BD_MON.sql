----bd_mon租户脚本----
DROP TABLE IF EXISTS NG3.TW_PERS_4G_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_4G_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   COMMON_IMEI    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_BAL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_BAL_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   USR_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_IMEI_USR_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_IMEI_USR_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   IMEI    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_VOC_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_VOC_BUSI_M (
   USR_NBR    STRING,
   STAT_MO    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_GPRS_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_GPRS_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_REDU_MH_CUST_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_REDU_MH_CUST_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_USRCALL_MO;
CREATE EXTERNAL TABLE NG3.TW_USRCALL_MO (
   TM_INTRVL_CD    INT,
   CNCT_NBR    STRING,
   A_USR_NBR    STRING,
   DIR_TYP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CSNM_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CSNM_M (
   USR_NBR    STRING,
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CSNM_CITY_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CSNM_CITY_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_MH_CUST_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_MH_CUST_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAMHOME_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAMHOME_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAMHOME_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAMHOME_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_CDR_USR_GPRS_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_CDR_USR_GPRS_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CDR_USR_WLAN_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_CDR_USR_WLAN_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   EVENT_FORMAT_YTP_CD    STRING,
   SRV_TYP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CDR_USR_VOC_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_CDR_USR_VOC_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   EVENT_FORMAT_YTP_CD    STRING,
   SRV_TYP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CDR_USRCALL_M;
CREATE EXTERNAL TABLE NG3.TW_CDR_USRCALL_M (
   DEBET_DT    INT,
   CALL_DT    INT,
   USR_NBR    STRING,
   EVENT_FORMAT_YTP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CHNL_INF_M;
CREATE EXTERNAL TABLE NG3.TW_CHNL_INF_M (
   STAT_MO    INT,
   CHNL_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CUST_BILL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CUST_BILL_M (
   EBOX_ID    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
   BILL_ACCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_USR_NBUSE_MO;
CREATE EXTERNAL TABLE NG3.TW_USR_NBUSE_MO (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   NEW_BUSI_CD    INT,
   CO_TYP_CD    INT,
...
DROP TABLE IF EXISTS NG3.TW_NB_GPRS_USR_PRDCT_ORDR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_GPRS_USR_PRDCT_ORDR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   BASS_PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_DEBET_BILL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_DEBET_BILL_M (
   USR_NBR    STRING,
   BILL_TYP_CD    STRING,
   TM_INTRVL_CD    INT,
   BILL_CUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CUST_CONSUME;
CREATE EXTERNAL TABLE NG3.TW_CUST_CONSUME (
   BILL_CYC_CD    INT,
   USR_ID    STRING,
   CUST_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_BILL_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_BILL_M (
   STAT_MO    INT,
   USR_ID    STRING,
   PAY_EBOX_ID    STRING,
   BILL_ACCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_MBR_ORDER_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_MBR_ORDER_M (
   STAT_MO    INT,
   GUSR_ID    STRING,
   USR_NBR    STRING,
   EFF_DT    INT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_MBR_CNSM_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_MBR_CNSM_M (
   STAT_MO    INT,
   GUSR_ID    STRING,
   USR_NBR    STRING,
   GCUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAMHOME_VNL_CALL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAMHOME_VNL_CALL_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   VNL_ACTCALL_DEBET_DUR    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAMHOME_MBR_INF_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAMHOME_MBR_INF_M (
   STAT_MO    INT,
   SUB_NBR    STRING,
   MASTER_NBR    STRING,
   SHORT_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAMHOME_INF_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAMHOME_INF_M (
   STAT_MO    INT,
   MASTER_NBR    STRING,
   SHORT_NBR_TYP    SMALLINT,
   SHORT_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_TERM_SELL_STS_M;
CREATE EXTERNAL TABLE NG3.TW_TERM_SELL_STS_M (
   STAT_MO    INT,
   IMEI    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CELLTYP_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CELLTYP_M (
   STAT_MO    INT,
   USR_MOB_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_IMEI_STS_M;
CREATE EXTERNAL TABLE NG3.TW_IMEI_STS_M (
   STAT_MO    INT,
   IMEI    STRING,
   FRST_EFF_DT    INT,
   FRST_EFF_TM    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_FETION_USR_USE_M;
CREATE EXTERNAL TABLE NG3.TW_NB_FETION_USR_USE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   PC_ACTV_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBREAD_ASCC_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBREAD_ASCC_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_DDLINE_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_DDLINE_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   GUSR_ID    STRING,
   GROUP_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_GPFLUX_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_GPFLUX_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   GUSR_ID    STRING,
   CORP_PRDCT_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_PRDCT_OWE_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_PRDCT_OWE_M (
   STAT_MO    INT,
   GUSR_ID    STRING,
   OWE_MO_CNT    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CORP_IND_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CORP_IND_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CORP_CNSM_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CORP_CNSM_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    INT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_MBR_ACT_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_MBR_ACT_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CORP_PRDCT_CODE    STRING,
   BRND_CD    INT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_PRDCT_CNSM_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_PRDCT_CNSM_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   GUSR_ID    STRING,
   GROUP_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_CUST_CNSM_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_CUST_CNSM_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
   BASS_PRDCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_CUST_BAS_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_CUST_BAS_M (
   STAT_MO    INT,
   GROUP_ID    STRING,
   CMCC_BRANCH_CD    STRING,
   CMCC_CNTRY_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TO_P_CORP_CUST_SRVINFO_UP_M;
CREATE EXTERNAL TABLE NG3.TO_P_CORP_CUST_SRVINFO_UP_M (
   GROUP_ID    STRING,
   PRVCGRP_TYP_CD    SMALLINT,
   NATGRP_TYP_CD    SMALLINT,
   PROF_TYP_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_PRDCT_RECACT_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_PRDCT_RECACT_M (
   STAT_MO    INT,
   GUSR_ID    STRING,
   BILL_CYC_CD    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_STAR_CUST_ASES_PROV_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_STAR_CUST_ASES_PROV_M (
   USR_NBR    STRING,
   STAT_MO    INT,
   ASES_DT    INT,
   USR_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_UNWOFF_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_UNWOFF_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   UNWOFF_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_4G_USR_BUSI_ATTR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_4G_USR_BUSI_ATTR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_GPRS_FLUX_LAYER_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_GPRS_FLUX_LAYER_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_SNAP_STK_USR_TRACK_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_SNAP_STK_USR_TRACK_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   ACT_VPMN_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TW_F_CUST_VAL_ANLYS_M;
CREATE EXTERNAL TABLE NG3.TW_F_CUST_VAL_ANLYS_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_ARPU_SNAP_USR_TRACK_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_ARPU_SNAP_USR_TRACK_M (
   USR_NBR    STRING,
   STAT_MO    INT,
   USR_ID    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_TERM_TAC_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_TERM_TAC_BUSI_M (
   STAT_MO    INT,
   TAC    STRING,
   TOT_USR_CNT    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAM_PAY_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAM_PAY_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   MAIN_NBR_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CONTR_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CONTR_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_CHNL_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_CHNL_BUSI_M (
   STAT_MO    INT,
   CHNL_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CS_12580_VIST_USR_M;
CREATE EXTERNAL TABLE NG3.TW_CS_12580_VIST_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_ELEC_CHNL_ACT_USR_M;
CREATE EXTERNAL TABLE NG3.TW_ELEC_CHNL_ACT_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CHNL_YK_M;
CREATE EXTERNAL TABLE NG3.TW_CHNL_YK_M (
   STAT_MO    INT,
   CHNL_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   CHNL_MAG_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_YK_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_YK_USR_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   CHNL_CD    STRING,
   CHNL_WARN_LVL_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_LAB_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_LAB_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_TERM_CHG_USR_BASE_M;
CREATE EXTERNAL TABLE NG3.TW_TERM_CHG_USR_BASE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_TERM_USR_IMEI_USE_STK_M;
CREATE EXTERNAL TABLE NG3.TW_TERM_USR_IMEI_USE_STK_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   IMEI    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_SPLIT_FLOW_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_SPLIT_FLOW_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_CHNL_INNET_INF_M;
CREATE EXTERNAL TABLE NG3.TW_CHNL_INNET_INF_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CHNL_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_TERM_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_TERM_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_STAR_CUST_ASES_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_STAR_CUST_ASES_M (
   USR_NBR    STRING,
   STAT_MO    INT,
   ASES_DT    INT,
   USR_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_STAR_RNK_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_STAR_RNK_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_KEY_KEEP_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_KEY_KEEP_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING
)
...
DROP TABLE IF EXISTS NG3.TW_PERS_HOMEBRB_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_HOMEBRB_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_REAL_NAME_INFO_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_REAL_NAME_INFO_M (
   STAT_MO    INT,
   USR_ID    STRING,
   CUST_ID    STRING,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CMPTUSR_CNTY_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CMPTUSR_CNTY_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   CMCC_CNTY_CD    STRING
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_CNTY_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_CNTY_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_CNTY_CD    STRING
)
...
DROP TABLE IF EXISTS NG3.TW_NB_MM_USR_STS_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MM_USR_STS_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LOGIN_TYP    STRING,
   LOGIN_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MNG_PLNTFM_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MNG_PLNTFM_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_SECUR_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_SECUR_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_WLAN_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_WLAN_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_MP_CXLM_EXT_EMP_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_MP_CXLM_EXT_EMP_BUSI_M (
   STAT_MO    INT,
   BUSI_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_KEY_BUSI_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_KEY_BUSI_USR_M (
   STAT_MO    INT,
   BUSI_TYP    STRING,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_RFID_SIM_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_RFID_SIM_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBTB_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBTB_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBREAD_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBREAD_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBNEWS_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBNEWS_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   SP_CODE    STRING,
   SP_SUBBUSI_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBNEWS_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBNEWS_M (
   STAT_MO    INT,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBNEWS_O_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBNEWS_O_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   ICP_SERV_ID    STRING,
   NEWS_CD    INT,
...
DROP TABLE IF EXISTS NG3.TW_NB_MM_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MM_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   PRTL_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_PCA_REL_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_PCA_REL_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_HI_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_HI_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_WETHER_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_WETHER_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   SP_SUBBUSI_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MAIL139_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MAIL139_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_CPRINT_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_CPRINT_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   USR_TYP    STRING,
   BUSI_TYP    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_PCA_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_PCA_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   USR_TYP    STRING,
   BUSI_TYP    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_SP_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_SP_BUSI_M (
   STAT_MO    INT,
   SP_CD    STRING,
   OPERATOR_CD    STRING,
   OPERATOR_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TW_SP_INFO_M;
CREATE EXTERNAL TABLE NG3.TW_SP_INFO_M (
   STAT_MO    INT,
   SP_CD    STRING,
   VALID_DT    INT,
   EXPIRE_DT    INT,
...
DROP TABLE IF EXISTS NG3.TW_USR_CNTY_MO;
CREATE EXTERNAL TABLE NG3.TW_USR_CNTY_MO (
   USR_NBR    STRING,
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_USRCALL_SPLSRVR_MO;
CREATE EXTERNAL TABLE NG3.TW_USRCALL_SPLSRVR_MO (
   USR_NBR    STRING,
   B_NBR    STRING,
   UPD_DT    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TO_NB_CPRINT_USR_ORDR_M;
CREATE EXTERNAL TABLE NG3.TO_NB_CPRINT_USR_ORDR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_PCA_USR_ORDR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_PCA_USR_ORDR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBLOT_USE_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBLOT_USE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   NEW_ACT_IND    STRING,
   BUY_CNT    INT,
...
DROP TABLE IF EXISTS NG3.TW_MOBGAME_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_MOBGAME_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_COM139_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_COM139_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   STS_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBPAY_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBPAY_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_CR_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_CR_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   GPRS_ACTV_USR_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_COM139_USE_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_COM139_USE_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   TERM_BRND    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBREAD_KPI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBREAD_KPI_M (
   USR_NBR    STRING,
   STRT_KPI_DT    INT,
   PRVC_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBNGTN_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBNGTN_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_SMS_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_SMS_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_MMS_BUSI_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MMS_BUSI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_VOICEMAIL_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_VOICEMAIL_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBFLASH_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBFLASH_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_NB_MOBVEDIO_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_MOBVEDIO_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_TERM_CHG_USR_M;
CREATE EXTERNAL TABLE NG3.TW_TERM_CHG_USR_M (
   STAT_MO    INT,
   STAT_CHG_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_DOUBT_TDNET_LOCK_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_DOUBT_TDNET_LOCK_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CUST_BILL_ORIG_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CUST_BILL_ORIG_M (
   EBOX_ID    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
   BILL_ACCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_GMCC_CMPT_VEST_JSSC_M;
CREATE EXTERNAL TABLE NG3.TW_GMCC_CMPT_VEST_JSSC_M (
   STAT_MO    INT,
   CMPT_USR_NBR    STRING,
   VEST_TYP_CD    STRING,
   VEST_LVL1_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_GMCC_USR_VEST_JSSC_M;
CREATE EXTERNAL TABLE NG3.TW_GMCC_USR_VEST_JSSC_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   VEST_TYP_CD    STRING,
   VEST_LVL1_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_BRND_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_BRND_M (
   USR_NBR    STRING,
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_CMPT_USR_M;
CREATE EXTERNAL TABLE NG3.TW_CMPT_USR_M (
   CMPT_NBR    STRING,
   AREA_CD    STRING,
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CUST_BAL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CUST_BAL_M (
   STAT_MO    INT,
   CUST_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_CMNCT_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_CMNCT_USR_M (
   USR_MOB_NBR    STRING,
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_USR_INTRCRS_MO;
CREATE EXTERNAL TABLE NG3.TW_USR_INTRCRS_MO (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   B_NBR    STRING,
   B_AREA_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_3G_TYJUSR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_3G_TYJUSR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   IMEI    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_INTEGRAL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_INTEGRAL_M (
   STAT_MO    INT,
   CUST_ID    STRING,
   USR_ID    STRING,
   INTEGRAL_CYC_DT    INT,
...
DROP TABLE IF EXISTS NG3.TW_NB_CNTN_GPRS_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_CNTN_GPRS_USR_M (
   STAT_MO    INT,
   IMSI    STRING,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_IOT_MBR_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_IOT_MBR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_ZBFZ_LIST_MO;
CREATE EXTERNAL TABLE NG3.TW_CORP_ZBFZ_LIST_MO (
   TM_INTRVL_CD    INT,
   GROUP_ID    STRING,
   GROUP_NO    STRING,
   PAR_GROUP_NO    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAMHOME_LOST_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAMHOME_LOST_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   INVALID_DT    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_12580_CALL_FEE_MO;
CREATE EXTERNAL TABLE NG3.TW_12580_CALL_FEE_MO (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_REDU_ACCT_MNTR_MO;
CREATE EXTERNAL TABLE NG3.TW_REDU_ACCT_MNTR_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   USR_NBR    STRING,
   ILGL_IND    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_IPHONE_USRCALL_MO;
CREATE EXTERNAL TABLE NG3.TW_IPHONE_USRCALL_MO (
   TM_INTRVL_CD    INT,
   CNCT_NBR    STRING,
   A_USR_NBR    STRING,
   DIR_TYP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_DIR_TOLL_DEL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_DIR_TOLL_DEL_M (
   USR_NBR    STRING,
   PRVC_NAM    STRING,
   B_AREA_CD    STRING,
   CTY_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TW_TERMPAY_PROV_ACTVCALL_M;
CREATE EXTERNAL TABLE NG3.TW_TERMPAY_PROV_ACTVCALL_M (
   STAT_DT    INT,
   IMEI    STRING,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_TERM_SELL_MO;
CREATE EXTERNAL TABLE NG3.TW_TERM_SELL_MO (
   TM_INTRVL_CD    INT,
   SELL_IMEI    STRING,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_IMEI_USRCALL_MO;
CREATE EXTERNAL TABLE NG3.TW_IMEI_USRCALL_MO (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   IMEI    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PRDCT_FREE_RES_M;
CREATE EXTERNAL TABLE NG3.TW_PRDCT_FREE_RES_M (
   STAT_DT    INT,
   USR_NBR    STRING,
   BASS_PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NET_CONT_PARSE_M;
CREATE EXTERNAL TABLE NG3.TW_NET_CONT_PARSE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   PARSE_1    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NET_KEYWD_M;
CREATE EXTERNAL TABLE NG3.TW_NET_KEYWD_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   KEYWD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NET_SITE_M;
CREATE EXTERNAL TABLE NG3.TW_NET_SITE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   SITE_TYP_ID    INT,
...
DROP TABLE IF EXISTS NG3.TW_NET_SR_M;
CREATE EXTERNAL TABLE NG3.TW_NET_SR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   SR_ENTER_ID    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_LACI_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_LACI_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   TOP1_INDATE    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_COMMON_APP_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_COMMON_APP_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   APP_WX_USR_IND    INT,
   APP_WX_FLUX    INT,
...
DROP TABLE IF EXISTS NG3.TW_NET_CONT_CATE_M;
CREATE EXTERNAL TABLE NG3.TW_NET_CONT_CATE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   CONT_CATE_LV1    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_ONOFF_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_ONOFF_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   ON_CNT    INT,
   OFF_CNT    INT
...
DROP TABLE IF EXISTS NG3.TW_PERS_COMMON_WEBSITE_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_COMMON_WEBSITE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   BAIDU_USR_IND    INT,
   BAIDU_FLUX    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_VOLTE_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_VOLTE_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   VOLTE_IMEI    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_BILL_HVOUT_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_BILL_HVOUT_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING
)
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_ATTR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_ATTR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   NBR_TYP_CD    STRING,
   INNET_CHNL_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_VOC_BUSI_DTL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_VOC_BUSI_DTL_M (
   USR_NBR    STRING,
   STAT_MO    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_4G_USR_TERM_D;
CREATE EXTERNAL TABLE NG3.TW_PERS_4G_USR_TERM_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_TOPN_APP_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_TOPN_APP_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   TOP1_APP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_CUST_YBILL_SPLT_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_CUST_YBILL_SPLT_M (
   EBOX_ID    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
   BILL_ACCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_OWE_DTL_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_OWE_DTL_M (
   STAT_MO    INT,
   USR_ID    STRING,
   PAY_EBOX_ID    STRING,
   BILL_ACCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_PRDCT_OWE_DTL_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_PRDCT_OWE_DTL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   GUSR_ID    STRING,
   GROUP_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_BILL_BBOSS_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_BILL_BBOSS_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   BBOSS_GUSR_ID    STRING,
   BBOSS_PRDCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PRDCT_RES_USE_M;
CREATE EXTERNAL TABLE NG3.TW_PRDCT_RES_USE_M (
   USR_ID    STRING,
   BASS_PRDCT_CD    STRING,
   PKG_FLUX    BIGINT,
   USE_PKG_FLUX    BIGINT,
...
DROP TABLE IF EXISTS NG3.TM_BASE_BILL_M;
CREATE EXTERNAL TABLE NG3.TM_BASE_BILL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   ITEM_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_FAVORITE_CHNL_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_FAVORITE_CHNL_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   CM_CHNL1_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_FREE_CHNL_OTH_M;
CREATE EXTERNAL TABLE NG3.TM_FREE_CHNL_OTH_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   FREE_DIM_CD1    STRING,
   ITEM_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CUST_VALUE_MINING_M;
CREATE EXTERNAL TABLE NG3.TW_CUST_VALUE_MINING_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TM_AIR_TRAVEL_STBY_VOC_M;
CREATE EXTERNAL TABLE NG3.TM_AIR_TRAVEL_STBY_VOC_M (
   DATA_DT    INT,
   CITY_ID    STRING,
   DIST_NAME    STRING,
   SEX_LAB    STRING,
...
DROP TABLE IF EXISTS NG3.TM_AIR_TRAVEL_STBY_FLUX_M;
CREATE EXTERNAL TABLE NG3.TM_AIR_TRAVEL_STBY_FLUX_M (
   DATA_DT    INT,
   CITY_ID    STRING,
   DIST_NAME    STRING,
   SEX_LAB    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NONAERO_TRANSPOR_STBY_VOC_M;
CREATE EXTERNAL TABLE NG3.TM_NONAERO_TRANSPOR_STBY_VOC_M (
   DATA_DT    INT,
   CITY_ID    STRING,
   DIST_NAM    STRING,
   TRIP_MODE    INT,
...
DROP TABLE IF EXISTS NG3.TM_NONAERO_TRANSPOR_STBY_FLUX_M;
CREATE EXTERNAL TABLE NG3.TM_NONAERO_TRANSPOR_STBY_FLUX_M (
   DATA_DT    INT,
   CITY_ID    STRING,
   DIST_NAM    STRING,
   TRIP_MODE    INT,
...
DROP TABLE IF EXISTS NG3.TM_DESTINA_STAY_STBY_VOC_M;
CREATE EXTERNAL TABLE NG3.TM_DESTINA_STAY_STBY_VOC_M (
   DATA_DT    INT,
   ARRIVAL_CITY    STRING,
   STAY_DUR    STRING,
   USR_CNT    INT
...
DROP TABLE IF EXISTS NG3.TM_DESTINA_STAY_STBY_FLUX_M;
CREATE EXTERNAL TABLE NG3.TM_DESTINA_STAY_STBY_FLUX_M (
   DATA_DT    INT,
   ARRIVAL_CITY    STRING,
   STAY_DUR    STRING,
   USR_CNT    INT
...
DROP TABLE IF EXISTS NG3.TM_DIVERTED_STAY_STBY_VOC_M;
CREATE EXTERNAL TABLE NG3.TM_DIVERTED_STAY_STBY_VOC_M (
   DATA_DT    INT,
...
DROP TABLE IF EXISTS NG3.TM_DIVERTED_STAY_STBY_FLUX_M;
CREATE EXTERNAL TABLE NG3.TM_DIVERTED_STAY_STBY_FLUX_M (
   DATA_DT    INT,
   DEPARTURE_CITY    STRING,
   STAY_DUR    STRING,
   USR_CNT    INT
...
DROP TABLE IF EXISTS NG3.TM_AIRLINE_PREFER_M;
CREATE EXTERNAL TABLE NG3.TM_AIRLINE_PREFER_M (
   DATA_DT    INT,
   DEPART_CITY    STRING,
   ARRIVAL_CITY    STRING,
   AIR_COMPANY    STRING,
...
DROP TABLE IF EXISTS NG3.TM_FLIGHT_PREFER_M;
CREATE EXTERNAL TABLE NG3.TM_FLIGHT_PREFER_M (
   DATA_DT    INT,
   DEPART_CITY    STRING,
   ARRIVAL_CITY    STRING,
   FLIGHT_NO    STRING,
...
DROP TABLE IF EXISTS NG3.TM_CHNL_MNTR_KPI_M;
CREATE EXTERNAL TABLE NG3.TM_CHNL_MNTR_KPI_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DIST_ID    STRING,
   MICRODIST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_ECPN_CHRG_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_ECPN_CHRG_M (
...
DROP TABLE IF EXISTS NG3.TW_CORP_ECPN_WOFF_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_ECPN_WOFF_M (
   EBOX_CHG_LOG_ID    STRING,
   CMCC_BRANCH_CD    STRING,
   EBOX_ID    STRING,
   EBOX_UNIT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_ECPN_BAL_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_ECPN_BAL_M (
   EBOX_CHG_LOG_ID    STRING,
   CMCC_BRANCH_CD    STRING,
   EBOX_ID    STRING,
   EBOX_UNIT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_OTH_M;
CREATE EXTERNAL TABLE NG3.TM_OTH_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   ITEM_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_USR_RESIDENCE_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_USR_RESIDENCE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   IMSI    STRING,
   IMEI    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_LAB2_USR_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_LAB2_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
