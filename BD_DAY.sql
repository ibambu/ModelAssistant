----bd_day租户脚本----
DROP TABLE IF EXISTS JCFW.TW_PERS_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_USR_D (
   USR_NBR    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
   NET_TYP    STRING,
...
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_USR_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TS_PERS_USR_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_USR_D (
   USR_NBR    STRING,
   USR_ID    STRING,
   CUST_ID    STRING,
   NET_TYP    STRING,
...
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_USR_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_USR_PKG_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_USR_PKG_D (
   USR_NBR    STRING,
   PKG_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_USR_PKG_D';

DROP TABLE IF EXISTS JCFW.TS_PERS_USR_PKG_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_USR_PKG_D (
   USR_NBR    STRING,
   PKG_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_USR_PKG_D';

DROP TABLE IF EXISTS JCFW.TO_PERS_USIM_D;
CREATE EXTERNAL TABLE JCFW.TO_PERS_USIM_D (
   USR_NBR    STRING,
   USIM_ID    STRING,
   CMCC_BRANCH_CD    STRING,
   STRT_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='&','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/ODS/TO_PERS_USIM_D';

DROP TABLE IF EXISTS JCFW.TS_PERS_USIM_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_USIM_D (
   USR_NBR    STRING,
   USIM_ID    STRING,
   CMCC_BRANCH_CD    STRING,
   STRT_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_USIM_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_USR_BAL_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_USR_BAL_D (
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   USR_ID    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_USR_BAL_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_OUTNET_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_OUTNET_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_OUTNET_USR_D';

DROP TABLE IF EXISTS JCFW.TW_USR_OTH_PAY_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_OTH_PAY_DAY (
   STAT_DT    INT,
   USR_MOB_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   A_BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_OTH_PAY_DAY';

DROP TABLE IF EXISTS JCFW.TW_USR_DF_PAY_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_DF_PAY_DAY (
   STAT_DT    INT,
   USR_MOB_NBR    STRING,
   B_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_DF_PAY_DAY';

DROP TABLE IF EXISTS JCFW.TW_USR_PRDCT_FIXFEE_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_PRDCT_FIXFEE_DAY (
   STAT_DT    INT,
   USR_MOB_NBR    STRING,
   BILL_ACCT_CD    STRING,
   BASS_PRDCT_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_PRDCT_FIXFEE_DAY';

DROP TABLE IF EXISTS JCFW.TW_USR_PRDCT_VOC_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_PRDCT_VOC_DAY (
   STAT_DT    INT,
   USR_MOB_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_PRDCT_VOC_DAY';

DROP TABLE IF EXISTS JCFW.TW_USR_PRDCT_WLAN_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_PRDCT_WLAN_DAY (
   STAT_DT    INT,
   USR_MOB_NBR    STRING,
   DISC_BASS_PRDCT_CD1    STRING,
   DISC_BASS_PRDCT_CD2    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_PRDCT_WLAN_DAY';

DROP TABLE IF EXISTS JCFW.TW_USR_PRDCT_GPRS_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_PRDCT_GPRS_DAY (
   STAT_DT    INT,
   USR_MOB_NBR    STRING,
   DISC_BASS_PRDCT_CD1    STRING,
   DISC_BASS_PRDCT_CD2    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_PRDCT_GPRS_DAY';

DROP TABLE IF EXISTS JCFW.TW_CDR_USR_GPRS_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_CDR_USR_GPRS_BUSI_D (
   DEBET_DT    INT,
   CALL_DT    INT,
   USR_NBR    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CDR_USR_GPRS_BUSI_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_CDR_USR_WLAN_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_CDR_USR_WLAN_BUSI_D (
   DEBET_DT    INT,
   CALL_DT    INT,
   USR_NBR    STRING,
   EVENT_FORMAT_YTP_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CDR_USR_WLAN_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_CDR_USRCALL_D;
CREATE EXTERNAL TABLE JCFW.TW_CDR_USRCALL_D (
   DEBET_DT    INT,
   CALL_DT    INT,
   USR_NBR    STRING,
   EVENT_FORMAT_YTP_CD    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CDR_USRCALL_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_CDR_USR_VOC_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_CDR_USR_VOC_BUSI_D (
   DEBET_DT    INT,
   CALL_DT    INT,
   USR_NBR    STRING,
   EVENT_FORMAT_YTP_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CDR_USR_VOC_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_CHNL_INF_D;
CREATE EXTERNAL TABLE JCFW.TW_CHNL_INF_D (
   CHNL_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CHNL_INF_D';

DROP TABLE IF EXISTS JCFW.TW_TERM_IMEI_SEQ_D;
CREATE EXTERNAL TABLE JCFW.TW_TERM_IMEI_SEQ_D (
   USR_NBR    STRING,
   IMEI    STRING,
   EFF_DT    INT,
   EFF_TM    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_TERM_IMEI_SEQ_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_USR_NBUSE_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_NBUSE_DAY (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   NEW_BUSI_CD    INT,
   CO_TYP_CD    INT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_NBUSE_DAY'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_BUSI_FEE_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_BUSI_FEE_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_BUSI_FEE_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_BNDCARD_ORDER_REL_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_BNDCARD_ORDER_REL_D (
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   CHG_DT    INT,
   ORDER_CMPT_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_BNDCARD_ORDER_REL_D';

DROP TABLE IF EXISTS JCFW.TW_USRCALL_STICK_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USRCALL_STICK_DAY (
   TM_INTRVL_CD    INT,
   USR_MOB_NBR    STRING,
   B_NBR    STRING,
   HR_CD    SMALLINT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USRCALL_STICK_DAY'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_FAMHOME_VNL_CALL_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FAMHOME_VNL_CALL_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FAMHOME_VNL_CALL_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_FAMHOME_MBR_INF_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FAMHOME_MBR_INF_D (
   SUB_NBR    STRING,
   MASTER_NBR    STRING,
   SHORT_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FAMHOME_MBR_INF_D';

DROP TABLE IF EXISTS JCFW.TS_PERS_FAMHOME_MBR_INF_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_FAMHOME_MBR_INF_D (
   SUB_NBR    STRING,
   MASTER_NBR    STRING,
   SHORT_NBR    STRING,
   SUB_SHORT_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_FAMHOME_MBR_INF_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_FAMHOME_INF_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FAMHOME_INF_D (
   MASTER_NBR    STRING,
   SHORT_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FAMHOME_INF_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_4G_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_4G_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   IMEI    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_4G_USR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_4G_USR_BUSI_ATTR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_4G_USR_BUSI_ATTR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   COMMON_IMEI    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_4G_USR_BUSI_ATTR_D';

DROP TABLE IF EXISTS JCFW.TW_TERM_SELL_STS_D;
CREATE EXTERNAL TABLE JCFW.TW_TERM_SELL_STS_D (
   IMEI    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_TERM_SELL_STS_D';

DROP TABLE IF EXISTS JCFW.TW_NB_GPRS_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_GPRS_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_GPRS_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_CELL_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_CELL_USR_D (
   STAT_DT    INT,
   CALL_DT    INT,
   USR_NBR    STRING,
   LOCAL_CD    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_CELL_USR_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_CMNCT_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_CMNCT_USR_D (
   USR_MOB_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_CMNCT_USR_D';

DROP TABLE IF EXISTS JCFW.TS_PERS_CMNCT_USR_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_CMNCT_USR_D (
   USR_MOB_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_CMNCT_USR_D';

DROP TABLE IF EXISTS JCFW.TW_TERM_IMEI_INV_SEQ_Y;
CREATE EXTERNAL TABLE JCFW.TW_TERM_IMEI_INV_SEQ_Y (
   USR_NBR    STRING,
   IMEI    STRING,
   EFF_DT    INT,
   EFF_TM    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_TERM_IMEI_INV_SEQ_Y';

DROP TABLE IF EXISTS JCFW.TW_IMEI_STS_D;
CREATE EXTERNAL TABLE JCFW.TW_IMEI_STS_D (
   IMEI    STRING,
   FRST_EFF_DT    INT,
   FRST_EFF_TM    STRING,
   FRST_USR_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_IMEI_STS_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_3G_TYJUSR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_3G_TYJUSR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   IMEI    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_3G_TYJUSR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_GPRS_BUSI_SUP_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_GPRS_BUSI_SUP_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   HR0_1_FLUX    BIGINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_GPRS_BUSI_SUP_D';

DROP TABLE IF EXISTS JCFW.TW_CS_12580_USR_USE_D;
CREATE EXTERNAL TABLE JCFW.TW_CS_12580_USR_USE_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   COOPR_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CS_12580_USR_USE_D';

DROP TABLE IF EXISTS JCFW.TW_CORP_CUST_BAS_D;
CREATE EXTERNAL TABLE JCFW.TW_CORP_CUST_BAS_D (
   GROUP_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CORP_CUST_BAS_D';

DROP TABLE IF EXISTS JCFW.TW_CS_12580_VIST_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_CS_12580_VIST_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CS_12580_VIST_USR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_CHRG_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_CHRG_USR_D (
   USR_NBR    STRING,
   TRADE_TYP    SMALLINT,
   CHRG_DT    INT,
   CHRG_TIM    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_CHRG_USR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_FAM_PAY_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FAM_PAY_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   MAIN_NBR_IND    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FAM_PAY_USR_D';

DROP TABLE IF EXISTS JCFW.TS_PERS_4G_USR_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_4G_USR_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_4G_USR_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_3G_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_3G_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   IMEI    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_3G_USR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_HOMEBRB_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_HOMEBRB_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_HOMEBRB_USR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_REAL_NAME_INFO_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_REAL_NAME_INFO_D (
   USR_ID    STRING,
   CUST_ID    STRING,
   USR_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_REAL_NAME_INFO_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_CMPTUSR_CNTY_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_CMPTUSR_CNTY_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   CMCC_CNTY_CD    STRING
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_CMPTUSR_CNTY_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_USR_CNTY_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_USR_CNTY_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_CNTY_CD    STRING
)
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_USR_CNTY_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_HOMEBRB_OUTNET_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_HOMEBRB_OUTNET_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_HOMEBRB_OUTNET_D';

DROP TABLE IF EXISTS JCFW.TW_NB_SECUR_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_SECUR_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_SECUR_BUSI_D';

DROP TABLE IF EXISTS JCFW.TS_NB_GPRS_USR_PRDCT_ORDR_D;
CREATE EXTERNAL TABLE JCFW.TS_NB_GPRS_USR_PRDCT_ORDR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   BASS_PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_NB_GPRS_USR_PRDCT_ORDR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_WLAN_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_WLAN_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_WLAN_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_GPRS_FLUX_MARKET_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_GPRS_FLUX_MARKET_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_GPRS_FLUX_MARKET_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBNGTN_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBNGTN_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBNGTN_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBTB_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBTB_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBTB_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_COM139_CDR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_COM139_CDR_D (
   STAT_DT    INT,
   SER_NO    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_COM139_CDR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBREAD_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBREAD_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBREAD_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBREAD_ASCC_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBREAD_ASCC_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBREAD_ASCC_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBNEWS_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBNEWS_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   SP_CODE    STRING,
   SP_SUBBUSI_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBNEWS_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBNEWS_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBNEWS_D (
   STAT_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBNEWS_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MM_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MM_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   PRTL_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MM_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_WETHER_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_WETHER_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   SP_SUBBUSI_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_WETHER_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_CPRINT_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_CPRINT_BUSI_D (
   USR_NBR    STRING,
   USR_TYP    STRING,
   STAT_DT    INT,
   BUSI_TYP    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_CPRINT_BUSI_D';

DROP TABLE IF EXISTS JCFW.TO_NB_CPRINT_USR_ORDR_D;
CREATE EXTERNAL TABLE JCFW.TO_NB_CPRINT_USR_ORDR_D (
   USR_NBR    STRING,
   PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   EFF_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/ODS/TO_NB_CPRINT_USR_ORDR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_PCA_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_PCA_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   USR_TYP    STRING,
   BUSI_TYP    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_PCA_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_PCA_USR_ORDR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_PCA_USR_ORDR_D (
   USR_NBR    STRING,
   PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   EFF_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_PCA_USR_ORDR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MM_USR_STS_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MM_USR_STS_D (
   USR_NBR    STRING,
   LOGIN_TYP    STRING,
   LOGIN_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MM_USR_STS_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MAIL139_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MAIL139_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MAIL139_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MAIL139_USR_STS_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MAIL139_USR_STS_D (
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   MAIL_SRVC_TYP_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MAIL139_USR_STS_D';

DROP TABLE IF EXISTS JCFW.TW_NB_FETION_USR_HIS_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_FETION_USR_HIS_D (
   USR_MOB_NBR    STRING,
   FETION_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_FETION_USR_HIS_D';

DROP TABLE IF EXISTS JCFW.TW_USRCALL_SPLSRVR_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USRCALL_SPLSRVR_DAY (
   USR_NBR    STRING,
   B_NBR    STRING,
   UPD_DT    INT,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USRCALL_SPLSRVR_DAY';

DROP TABLE IF EXISTS JCFW.TW_WLC_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_WLC_BUSI_D (
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   JOIN_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_WLC_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBLOT_USE_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBLOT_USE_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   BUY_CNT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBLOT_USE_D';

DROP TABLE IF EXISTS JCFW.TW_MOBGAME_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_MOBGAME_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_MOBGAME_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_COM139_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_COM139_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_COM139_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBPAY_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBPAY_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBPAY_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBGAME_DOWN_NAM_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBGAME_DOWN_NAM_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   SP_CODE    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBGAME_DOWN_NAM_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBREAD_PV_BOOK_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBREAD_PV_BOOK_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   BOOK_ID    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBREAD_PV_BOOK_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MNG_PLNTFM_DOWN_WSONG_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MNG_PLNTFM_DOWN_WSONG_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   ORD_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MNG_PLNTFM_DOWN_WSONG_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MM_APP_DOWN_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MM_APP_DOWN_D (
   STAT_DT    INT,
   AP_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MM_APP_DOWN_D';

DROP TABLE IF EXISTS JCFW.TW_NB_FETION_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_FETION_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_FETION_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_CR_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_CR_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_CR_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MNG_PLNTFM_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MNG_PLNTFM_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MNG_PLNTFM_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_SMS_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_SMS_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_SMS_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MMS_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MMS_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MMS_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_NB_VOICEMAIL_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_VOICEMAIL_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_VOICEMAIL_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBFLASH_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBFLASH_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBFLASH_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_MOBVEDIO_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_MOBVEDIO_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_MOBVEDIO_USR_D';

DROP TABLE IF EXISTS JCFW.TW_GMCC_USR_VEST_JSSC_D;
CREATE EXTERNAL TABLE JCFW.TW_GMCC_USR_VEST_JSSC_D (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   VEST_TYP_CD    STRING,
   VEST_LVL1_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_GMCC_USR_VEST_JSSC_D';

DROP TABLE IF EXISTS JCFW.TW_CORP_CUST_DELEGATE_INF_D;
CREATE EXTERNAL TABLE JCFW.TW_CORP_CUST_DELEGATE_INF_D (
   CUST_ID    STRING,
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   DELEGATE_NAM    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CORP_CUST_DELEGATE_INF_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_ACTV_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_ACTV_USR_D (
   USR_MOB_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_ACTV_USR_D';

DROP TABLE IF EXISTS JCFW.TS_PERS_ACTV_USR_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_ACTV_USR_D (
   USR_MOB_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   ACTV_USR_IND    SMALLINT,
   CM_ACTV_DAYS    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_ACTV_USR_D';

DROP TABLE IF EXISTS JCFW.TW_CMPT_CALL_D;
CREATE EXTERNAL TABLE JCFW.TW_CMPT_CALL_D (
   STAT_DT    INT,
   COOPR_NBR    STRING,
   COOPR_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CMPT_CALL_D';

DROP TABLE IF EXISTS JCFW.TW_USRCALL_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USRCALL_DAY (
   CALL_DT    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   CNCT_NBR    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USRCALL_DAY';

DROP TABLE IF EXISTS JCFW.TW_PERS_FAMHOME_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FAMHOME_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FAMHOME_BUSI_D';

DROP TABLE IF EXISTS JCFW.TW_CMPT_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_CMPT_USR_D (
   CMPT_NBR    STRING,
   AREA_CD    STRING,
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CMPT_USR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_FAMHOME_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FAMHOME_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FAMHOME_USR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_HOMEBRB_FLUX_USEAGE_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_HOMEBRB_FLUX_USEAGE_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_HOMEBRB_FLUX_USEAGE_D';

DROP TABLE IF EXISTS JCFW.TW_CORP_PRDCT_MBR_D;
CREATE EXTERNAL TABLE JCFW.TW_CORP_PRDCT_MBR_D (
   USR_NBR    STRING,
   GUSR_ID    STRING,
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CORP_PRDCT_MBR_D';

DROP TABLE IF EXISTS JCFW.TO_P_GCUST_D;
CREATE EXTERNAL TABLE JCFW.TO_P_GCUST_D (
   CUST_ID    STRING,
   AREA_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/ODS/TO_P_GCUST_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_FREE_RES_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FREE_RES_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'=',','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FREE_RES_D';

DROP TABLE IF EXISTS JCFW.TW_12593_USR_DAY;
CREATE EXTERNAL TABLE JCFW.TW_12593_USR_DAY (
   TM_INTRVL_CD    INT,
   USR_MOB_NBR    STRING,
   HR_IND    STRING,
   TOLL_TYP_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_12593_USR_DAY';

DROP TABLE IF EXISTS JCFW.TW_PERS_FORWARD_189_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_FORWARD_189_D (
   USR_MOB_NBR    STRING,
   A_BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   B_NBR    STRING
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_FORWARD_189_D';

DROP TABLE IF EXISTS JCFW.TW_USR_PRVC_ACTCALL_MO_TMP_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_PRVC_ACTCALL_MO_TMP_DAY (
   USR_NBR    STRING,
   CALL_AREA_CD    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    INT,
...
WITH SERDEPROPERTIES ('field.delim'='&','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_PRVC_ACTCALL_MO_TMP_DAY';

DROP TABLE IF EXISTS JCFW.TW_PERS_SPLAN_USR_4G_FLUX_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_SPLAN_USR_4G_FLUX_D (
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   CALL_DT    INT
)
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_SPLAN_USR_4G_FLUX_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_SPLAN_USR_4G_FLUX_EXPED_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_SPLAN_USR_4G_FLUX_EXPED_D (
   USR_NBR    STRING,
   USR_ID    STRING
)
PARTITIONED BY (branch STRING,month INT,day INT)
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_SPLAN_USR_4G_FLUX_EXPED_D';

DROP TABLE IF EXISTS JCFW.TW_USR_INTRCRS_MO_TMP_DAY;
CREATE EXTERNAL TABLE JCFW.TW_USR_INTRCRS_MO_TMP_DAY (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   B_NBR    STRING,
   B_AREA_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_USR_INTRCRS_MO_TMP_DAY';

DROP TABLE IF EXISTS JCFW.TW_IMEI_USRCALL_MO_TMP_DAY;
CREATE EXTERNAL TABLE JCFW.TW_IMEI_USRCALL_MO_TMP_DAY (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   IMEI    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='&','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_IMEI_USRCALL_MO_TMP_DAY';

DROP TABLE IF EXISTS JCFW.TO_P_234G_LACI_D;
CREATE EXTERNAL TABLE JCFW.TO_P_234G_LACI_D (
   HOUR_ID    INT,
   MSISDN    STRING,
   STAT_DT    INT,
   TOP1_INDATE    INT,
...
WITH SERDEPROPERTIES ('field.delim'=',','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/ODS/TO_P_234G_LACI_D';

DROP TABLE IF EXISTS JCFW.TS_PERS_USR_BAL_D;
CREATE EXTERNAL TABLE JCFW.TS_PERS_USR_BAL_D (
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   USR_ID    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/STAGE/TS_PERS_USR_BAL_D';

DROP TABLE IF EXISTS JCFW.TW_PRDCT_FREE_RES_D;
CREATE EXTERNAL TABLE JCFW.TW_PRDCT_FREE_RES_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   BASS_PRDCT_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PRDCT_FREE_RES_D';

DROP TABLE IF EXISTS JCFW.TO_PERS_BRND_D;
CREATE EXTERNAL TABLE JCFW.TO_PERS_BRND_D (
   USR_NBR    STRING,
   START_DT    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/ODS/TO_PERS_BRND_D';

DROP TABLE IF EXISTS JCFW.TR_GSMTDLTE_CELL;
CREATE EXTERNAL TABLE JCFW.TR_GSMTDLTE_CELL (
   CELL_CGI    STRING,
   RES_NE_ID    STRING,
   NE_NAM    STRING,
   NE_FULL_NAM    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/REF/TR_GSMTDLTE_CELL';

DROP TABLE IF EXISTS JCFW.TO_NET_CS_2G_3G_CDR_D;
CREATE EXTERNAL TABLE JCFW.TO_NET_CS_2G_3G_CDR_D (
   BTIME    STRING,
   ETIME    STRING,
...
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/ODS/TO_NET_CS_2G_3G_CDR_D';

DROP TABLE IF EXISTS JCFW.TW_NET_CONT_PARSE_D;
CREATE EXTERNAL TABLE JCFW.TW_NET_CONT_PARSE_D (
   HOUR_ID    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   PARSE_1    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NET_CONT_PARSE_D';

DROP TABLE IF EXISTS JCFW.TW_NET_KEYWD_D;
CREATE EXTERNAL TABLE JCFW.TW_NET_KEYWD_D (
   HOUR_ID    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   KEYWD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NET_KEYWD_D';

DROP TABLE IF EXISTS JCFW.TW_NET_SITE_D;
CREATE EXTERNAL TABLE JCFW.TW_NET_SITE_D (
   HOUR_ID    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   SITE_TYP_ID    INT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NET_SITE_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='UTF-8');

DROP TABLE IF EXISTS JCFW.TW_NET_SR_D;
CREATE EXTERNAL TABLE JCFW.TW_NET_SR_D (
   HOUR_ID    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   SR_ENTER_ID    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NET_SR_D';

DROP TABLE IF EXISTS JCFW.TW_P_234G_LACI_D;
CREATE EXTERNAL TABLE JCFW.TW_P_234G_LACI_D (
   HOUR_ID    INT,
   USR_NBR    STRING,
   IMEI    STRING,
   STAT_DT    INT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_P_234G_LACI_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='UTF-8');

DROP TABLE IF EXISTS JCFW.TW_PERS_TOPN_APP_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_TOPN_APP_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   TOP1_APP_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_TOPN_APP_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_TRACK_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_TRACK_D (
   STAT_DT    INT,
   IN_TIME    STRING,
   USR_NBR    STRING,
   OLAC_ID    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_TRACK_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='UTF-8');

DROP TABLE IF EXISTS JCFW.TW_PERS_RESIDENCE_TIME_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_RESIDENCE_TIME_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   LAC_ID    STRING,
   CELL_ID    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_RESIDENCE_TIME_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='UTF-8');

DROP TABLE IF EXISTS JCFW.TW_NET_CONT_CATE_D;
CREATE EXTERNAL TABLE JCFW.TW_NET_CONT_CATE_D (
   HOUR_ID    INT,
   USR_NBR    STRING,
   NET_TYP_CD    INT,
   CONT_CATE_LV1    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NET_CONT_CATE_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_ONOFF_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_ONOFF_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   ON_CNT    INT,
   OFF_CNT    INT
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_ONOFF_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_TOPN_KEYWD_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_TOPN_KEYWD_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   TOP1_KEYWD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_TOPN_KEYWD_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_TOPN_KEYWD_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_TOPN_KEYWD_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   TOP1_KEYWD    STRING,
   TOP1_KEYWD_CNT    BIGINT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_TOPN_KEYWD_M';

DROP TABLE IF EXISTS JCFW.TW_PERS_VOLTE_USR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_VOLTE_USR_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   VOLTE_IMEI    STRING,
...
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_VOLTE_USR_D';

DROP TABLE IF EXISTS JCFW.TW_NB_WLAN_TERMOS_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TW_NB_WLAN_TERMOS_BUSI_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   TERM_TYP_CD    STRING,
   OS_TYP_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='\001','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_NB_WLAN_TERMOS_BUSI_D';

DROP TABLE IF EXISTS JCFW.TM_NET_SR_APP_D;
CREATE EXTERNAL TABLE JCFW.TM_NET_SR_APP_D (
   STAT_DT    INT,
   SR_SERVER_ID    INT,
   SR_SERVER_NAM    STRING,
   SR_CONT_TYP_ID    INT,
...
WITH SERDEPROPERTIES ('field.delim'='&','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_NET_SR_APP_D';

DROP TABLE IF EXISTS JCFW.TW_CORP_MBR_ORDER_D;
CREATE EXTERNAL TABLE JCFW.TW_CORP_MBR_ORDER_D (
   STAT_DT    INT,
   GUSR_ID    STRING,
   USR_NBR    STRING,
   EFF_DT    INT,
...
WITH SERDEPROPERTIES ('field.delim'='\001','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CORP_MBR_ORDER_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_LIVING_CIRCLE_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_LIVING_CIRCLE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_LIVING_CIRCLE_M'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_4GLIFE_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_4GLIFE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_4GLIFE_M'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_BASIC_FEATURE_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_BASIC_FEATURE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_BASIC_FEATURE_M'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_BEHAVIOR_HABIT_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_BEHAVIOR_HABIT_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_BEHAVIOR_HABIT_M'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_PERSONAL_TAILOR_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_PERSONAL_TAILOR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_PERSONAL_TAILOR_M'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_USER_FILE_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_USER_FILE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_USER_FILE_M'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_SPENDING_POWER_M;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_SPENDING_POWER_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_SPENDING_POWER_M'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TM_NB_CNTN_GPRS_SERV_D;
CREATE EXTERNAL TABLE JCFW.TM_NB_CNTN_GPRS_SERV_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   IMSI    STRING,
   NET_TYP_CD    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='&','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_NB_CNTN_GPRS_SERV_D';

DROP TABLE IF EXISTS JCFW.TM_MMS_APP;
CREATE EXTERNAL TABLE JCFW.TM_MMS_APP (
   COLLECT_DT    INT                ,
   Date_CD    INT                    ,
   Send_City_ID    BIGINT     ,
   Recv_city_id    BIGINT     ,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_MMS_APP'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TM_MMSC_CNT;
CREATE EXTERNAL TABLE JCFW.TM_MMSC_CNT (
   DATE_CD    INT,
   COLLECT_DT    INT,
   USER_ID    STRING,
   CITY_ID    BIGINT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_MMSC_CNT'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TM_WAP_GWUSER_HR;
CREATE EXTERNAL TABLE JCFW.TM_WAP_GWUSER_HR (
   HR_CD    INT,
   Date_CD    BIGINT,
   SYSTEM_ID    BIGINT,
   UserBrand_CD    INT,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_WAP_GWUSER_HR';

DROP TABLE IF EXISTS JCFW.TM_WAP_SPUSER_ACCDATE;
CREATE EXTERNAL TABLE JCFW.TM_WAP_SPUSER_ACCDATE (
   COLLECT_DT    BIGINT,
   MSISDN    STRING,
   DATE_CD    BIGINT,
   SP_GROUP_NAM    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='@#$','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_WAP_SPUSER_ACCDATE';

DROP TABLE IF EXISTS JCFW.TM_PERS_NEW_USR_D;
CREATE EXTERNAL TABLE JCFW.TM_PERS_NEW_USR_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   DIST_ID    STRING,
   MICRODIST_ID    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_PERS_NEW_USR_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');
...
DROP TABLE IF EXISTS JCFW.TM_CHNL_MNTR_KPI_D;
CREATE EXTERNAL TABLE JCFW.TM_CHNL_MNTR_KPI_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   DIST_ID    STRING,
   MICRODIST_ID    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_CHNL_MNTR_KPI_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TM_CHNL_MNTR_TERMKPI_D;
CREATE EXTERNAL TABLE JCFW.TM_CHNL_MNTR_TERMKPI_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   DIST_ID    STRING,
   MICRODIST_ID    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_CHNL_MNTR_TERMKPI_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TM_TARGET_USR_4GINVERT_D;
CREATE EXTERNAL TABLE JCFW.TM_TARGET_USR_4GINVERT_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   ACTIVITY_TYP    STRING,
   USR_CNT    INT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_TARGET_USR_4GINVERT_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_OPENTODMP;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_OPENTODMP (
   STAT_MO    INT,
   USR_NBR    STRING,
   LAB_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
PARTITIONED BY (branch STRING)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_OPENTODMP'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_NETPLAY_BEHAVIOR_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_NETPLAY_BEHAVIOR_D (
   MSISDN    STRING,
   IMSI    STRING,
   IMEI    STRING,
...
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_NETPLAY_BEHAVIOR_D';

DROP TABLE IF EXISTS JCFW.TW_PERS_LAB_TRAVEL_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_LAB_TRAVEL_D (
   MSISDN    STRING,
   IMSI    STRING,
   IMEI    STRING,
   ROAM_TRAVEL_FLAG    STRING,
...
WITH SERDEPROPERTIES ('field.delim'='\001','serialization.null.format' ='NVL','serialization.encoding' ='UTF-8')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_LAB_TRAVEL_D';

DROP TABLE IF EXISTS JCFW.TM_TIMES_OPER_MNTR_KPI_D;
CREATE EXTERNAL TABLE JCFW.TM_TIMES_OPER_MNTR_KPI_D (
   STAT_DT    INT,
   CMCC_BRANCH_CD    STRING,
   AREA_ID    STRING,
   CHNL_CD    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/DM/TM_TIMES_OPER_MNTR_KPI_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_CMPT_FST_LOCALCALL_D;
CREATE EXTERNAL TABLE JCFW.TW_CMPT_FST_LOCALCALL_D (
   STAT_DT    INT,
   COOPR_NBR    STRING,
   COOPR_CD    STRING,
   COOPR_BRND_CD    SMALLINT,
...
WITH SERDEPROPERTIES ('field.delim'='\001','serialization.null.format' ='NVL','serialization.encoding' ='GBK')
STORED AS TEXTFILE
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_CMPT_FST_LOCALCALL_D';

DROP TABLE IF EXISTS JCFW.TYJ_PERS_NET_BUSI_D;
CREATE EXTERNAL TABLE JCFW.TYJ_PERS_NET_BUSI_D (
   USR_NBR    STRING,
   GROUP_SOFT_CD    INT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/GIF/TYJ_PERS_NET_BUSI_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_BIXF_HARASS_CALL_REPORT_D;
CREATE EXTERNAL TABLE JCFW.TW_BIXF_HARASS_CALL_REPORT_D (
   STAT_DT    INT,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_BIXF_HARASS_CALL_REPORT_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');

DROP TABLE IF EXISTS JCFW.TW_PERS_USR_RESIDENCE_D;
CREATE EXTERNAL TABLE JCFW.TW_PERS_USR_RESIDENCE_D (
   STAT_DT    INT,
   USR_NBR    STRING,
   IMSI    STRING,
   IMEI    STRING,
...
PARTITIONED BY (branch STRING,month INT,day INT)
STORED AS PARQUET
LOCATION '/tenant/BIGDATA/JCFW/BZMX/DAY/EDS/TW_PERS_USR_RESIDENCE_D'
TBLPROPERTIES ('serialization.null.format' ='NVL','serialization.encoding' ='GBK');
