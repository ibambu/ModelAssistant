----bd_gdmm租户脚本----
DROP TABLE IF EXISTS NG3.TW_BASS_GUSR_MO;
CREATE EXTERNAL TABLE NG3.TW_BASS_GUSR_MO (
   TM_INTRVL_CD    INT,
   CUST_ID    STRING,
   USR_ID    STRING,
   AREA_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_BASS_CORP_PRDCT_MO;
CREATE EXTERNAL TABLE NG3.TW_BASS_CORP_PRDCT_MO (
   TM_INTRVL_CD    INT,
   GUSR_ID    STRING,
   AREA_CD    STRING,
   INTRL_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_BRCC_SNAP;
CREATE EXTERNAL TABLE NG3.TW_CORP_BRCC_SNAP (
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
   SNGRP_AB_CD    STRING
)
...
DROP TABLE IF EXISTS NG3.TW_CORP_INCOME;
CREATE EXTERNAL TABLE NG3.TW_CORP_INCOME (
   TM_INTRVL_CD    INT,
   GROUP_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_DATA;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_DATA (
   TM_INTRVL_CD    INT,
   GROUP_ID    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PROVCORP_UP;
CREATE EXTERNAL TABLE NG3.TW_PROVCORP_UP (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_CORP_CMCC_CNTRY;
CREATE EXTERNAL TABLE NG3.TR_CORP_CMCC_CNTRY (
   CMCC_BRANCH_CD    STRING,
   CMCC_CNTRY_CD    STRING,
...
ALTER TABLE NG3.TR_CORP_CMCC_CNTRY ADD PARTITION (branch='GMCC');

DROP TABLE IF EXISTS NG3.TW_CORP_STDPRDCT;
CREATE EXTERNAL TABLE NG3.TW_CORP_STDPRDCT (
   TM_INTRVL_CD    INT,
   GROUP_ID    STRING,
   GUSR_ID    STRING,
   GCUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TR_CORP_PRDCT;
CREATE EXTERNAL TABLE NG3.TR_CORP_PRDCT (
   PRDCT_CODE    STRING,
   PRDCT_NAM    STRING,
   PRDCT_TYP    STRING,
   CARRY_TYP    STRING,
...
ALTER TABLE NG3.TR_CORP_PRDCT ADD PARTITION (branch='GMCC');

DROP TABLE IF EXISTS NG3.TW_CORP_TF_EBOX_RELA_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_TF_EBOX_RELA_M (
   STAT_MO    INT,
   EBOX_ID    STRING,
   GROUP_ID    STRING,
   GCUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_ADC_CORP_MEMBER_MO;
CREATE EXTERNAL TABLE NG3.TW_ADC_CORP_MEMBER_MO (
   TM_INTRVL_CD    INT,
   GUSR_ID    STRING,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_MAS_DATA_RAW;
CREATE EXTERNAL TABLE NG3.TW_CORP_MAS_DATA_RAW (
   TM_INTRVL_CD    INT,
   SORT_ID    STRING,
   MANU_NAM    STRING,
   CMCC_BRANCH    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_USEUSR;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_USEUSR (
   TM_INTRVL_CD    INT,
   SP_CODE    STRING,
   SP_SERV_CD    STRING,
   SP_SUBBUSI_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_LJUSEUSR;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_LJUSEUSR (
   TM_INTRVL_CD    INT,
   SP_CODE    STRING,
   SP_SERV_CD    STRING,
   SP_SUBBUSI_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_GUSRCALL_MO;
CREATE EXTERNAL TABLE NG3.TW_GUSRCALL_MO (
   TM_INTRVL_CD    INT,
   GROUP_ID    STRING,
   GCUST_ID    STRING,
   GUSR_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_GCUST_CONSUME;
CREATE EXTERNAL TABLE NG3.TW_GCUST_CONSUME (
   BILL_CYC_CD    INT,
   USR_ID    STRING,
   GRP_AGGREGATE_IND    STRING,
   CUST_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_CODEBI;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_CODEBI (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
   INDUSTRY_PRDCT_TYP    INT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_MAS_DATA;
CREATE EXTERNAL TABLE NG3.TW_CORP_MAS_DATA (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   MAS_ID    STRING,
   GROUP_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_PDTPRT_RELA_MO;
CREATE EXTERNAL TABLE NG3.TW_CORP_PDTPRT_RELA_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   GUSR_ID    STRING,
   CORP_USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TR_INDUSTRY_PRDCT_TYP;
CREATE EXTERNAL TABLE NG3.TR_INDUSTRY_PRDCT_TYP (
   INDUSTRY_PRDCT_TYP    INT,
   INDUSTRY_PRDCT_NAM    STRING,
   INDAPPLY_ZB_IND    STRING,
   YJ_PRD_CODE    STRING
...
ALTER TABLE NG3.TR_INDUSTRY_PRDCT_TYP ADD PARTITION (branch='GMCC');

DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_CODE;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_CODE (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   INDUSTRY_PRDCT_TYP    INT,
   INDUSTRY_PRDCT_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_CODE_RAW;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_CODE_RAW (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
   INDUSTRY_PRDCT_TYP    INT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_CODE_PREVIEW;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_CODE_PREVIEW (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
   INDUSTRY_PRDCT_TYP    INT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_INDAPPLY_CODE_RATIFY;
CREATE EXTERNAL TABLE NG3.TW_CORP_INDAPPLY_CODE_RATIFY (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   GROUP_ID    STRING,
   INDUSTRY_PRDCT_TYP    INT,
...
DROP TABLE IF EXISTS NG3.TW_APN_USR_MO;
CREATE EXTERNAL TABLE NG3.TW_APN_USR_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   USR_NBR    STRING,
   APN_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NB_MOBLOT_DTL_M;
CREATE EXTERNAL TABLE NG3.TM_NB_MOBLOT_DTL_M (
   STAT_MO    INT,
   LOTRY_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_NB_MOBLOT_DVLP_M;
CREATE EXTERNAL TABLE NG3.TM_NB_MOBLOT_DVLP_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_G3_MBR_MO;
CREATE EXTERNAL TABLE NG3.TW_CORP_G3_MBR_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   USR_NBR    STRING,
   USR_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_APN_USEUSR_MO;
CREATE EXTERNAL TABLE NG3.TW_CORP_APN_USEUSR_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   APN_NBR    STRING,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_MEMBER_CRM_MO;
CREATE EXTERNAL TABLE NG3.TW_CORP_MEMBER_CRM_MO (
   TM_INTRVL_CD    INT,
   GROUP_ID    STRING,
   USR_ID    STRING,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_BARGAIN_USR_MO;
CREATE EXTERNAL TABLE NG3.TW_CORP_BARGAIN_USR_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   PRDCT_TYP    STRING,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CORP_BARGAIN_REG_USR_M;
CREATE EXTERNAL TABLE NG3.TW_CORP_BARGAIN_REG_USR_M (
   STAT_MO    INT,
   USR_NBR    STRING,
   GROUP_ID    STRING,
   GUSR_ID    STRING,
...
DROP TABLE IF EXISTS NG3.TW_F_USR_COST_TRANS_DIV_M;
CREATE EXTERNAL TABLE NG3.TW_F_USR_COST_TRANS_DIV_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_F_CUST_INC_DIV_M;
CREATE EXTERNAL TABLE NG3.TW_F_CUST_INC_DIV_M (
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TW_F_PRDCT_BUSI_DIV_M;
CREATE EXTERNAL TABLE NG3.TW_F_PRDCT_BUSI_DIV_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TR_TERM_INF_M;
CREATE EXTERNAL TABLE NG3.TR_TERM_INF_M (
   TERM_MDL_ID    INT,
   TERM_TYP    STRING,
   PROD_CORP    STRING,
...
DROP TABLE IF EXISTS NG3.TR_TAC_TERM_M;
CREATE EXTERNAL TABLE NG3.TR_TAC_TERM_M (
   TAC    STRING,
   TERM_MDL_ID    INT,
   TERM_DS_ID    INT,
   TERM_MDL_KEY    INT,
...
DROP TABLE IF EXISTS NG3.TW_F_PRDCT_USE_M;
CREATE EXTERNAL TABLE NG3.TW_F_PRDCT_USE_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TR_TERM_PRDCT_M;
CREATE EXTERNAL TABLE NG3.TR_TERM_PRDCT_M (
   TAC    STRING,
   TERM_BRND_NAM    STRING,
   TERM_BRND_NAM_EN    STRING,
   TERM_MDL_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TW_PERS_MIN_CNSM_M;
CREATE EXTERNAL TABLE NG3.TW_PERS_MIN_CNSM_M (
   STAT_MO    INT,
   USR_NBR    STRING,
...
DROP TABLE IF EXISTS NG3.TM_139_MAIL_USR_AGGR_MO;
CREATE EXTERNAL TABLE NG3.TM_139_MAIL_USR_AGGR_MO (
   TM_INTRVL_CD    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   REACH_USRCNT    INT,
...
DROP TABLE IF EXISTS NG3.TM_FETION_USR_MO;
CREATE EXTERNAL TABLE NG3.TM_FETION_USR_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   USR_TYP_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_FETION_USE_MO;
CREATE EXTERNAL TABLE NG3.TM_FETION_USE_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_BIXF_CMNCT_USR_MO;
CREATE EXTERNAL TABLE NG3.TW_BIXF_CMNCT_USR_MO (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_SHL_AREA_USE_DTL_MO;
CREATE EXTERNAL TABLE NG3.TW_SHL_AREA_USE_DTL_MO (
   TM_INTRVL_CD    INT,
   USR_NBR    STRING,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_F_INOUT_NET_SETL_M;
CREATE EXTERNAL TABLE NG3.TM_F_INOUT_NET_SETL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_F_LOCALFEE_FC_M;
CREATE EXTERNAL TABLE NG3.TM_F_LOCALFEE_FC_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_F_BOSS_USER_XZ_M;
CREATE EXTERNAL TABLE NG3.TM_F_BOSS_USER_XZ_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_JF_SP_MO;
CREATE EXTERNAL TABLE NG3.TM_JF_SP_MO (
   TM_INTRVL_CD    INT,
...
DROP TABLE IF EXISTS NG3.TM_JF_SP_OTH_MO;
CREATE EXTERNAL TABLE NG3.TM_JF_SP_OTH_MO (
   TM_INTRVL_CD    INT,
...
DROP TABLE IF EXISTS NG3.TM_JF_SP_SMS_MO;
CREATE EXTERNAL TABLE NG3.TM_JF_SP_SMS_MO (
   TM_INTRVL_CD    INT,
   SP_BUSI_TYP_2    SMALLINT,
   SP_CNT    INT,
...
DROP TABLE IF EXISTS NG3.TM_JF_SP_MMS_MO;
CREATE EXTERNAL TABLE NG3.TM_JF_SP_MMS_MO (
   TM_INTRVL_CD    INT,
   SP_BUSI_TYP_2    SMALLINT,
   SP_CNT    INT,
   UP_CMNCT_FEE    DECIMAL(16,2),
...
DROP TABLE IF EXISTS NG3.TM_MWSMS_NOTBALA_MO;
CREATE EXTERNAL TABLE NG3.TM_MWSMS_NOTBALA_MO (
   TM_INTRVL_CD    INT,
   BUSCODE    STRING,
   ADDRESS_CODE    STRING,
   SP_CODE    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NB_SMS_BUSI_DTL_SRC_M;
CREATE EXTERNAL TABLE NG3.TM_NB_SMS_BUSI_DTL_SRC_M (
   DEBET_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_CD    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NB_SMS_BUSI_SRC_M;
CREATE EXTERNAL TABLE NG3.TM_NB_SMS_BUSI_SRC_M (
   DEBET_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_CD    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_CHRGCARD_CHRG_MO;
CREATE EXTERNAL TABLE NG3.TM_CHRGCARD_CHRG_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    INT,
...
DROP TABLE IF EXISTS NG3.TW_PERS_ARPUSNAP_USR_Y;
CREATE EXTERNAL TABLE NG3.TW_PERS_ARPUSNAP_USR_Y (
   STAT_YEAR    INT,
   USR_NBR    STRING,
   USR_ID    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TW_CORP_M2M_PRDCT_MO;
CREATE EXTERNAL TABLE NG3.TW_CORP_M2M_PRDCT_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   APN_NBR    STRING,
   CUST_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_F_BILL_INCOME_SUM_M;
CREATE EXTERNAL TABLE NG3.TM_F_BILL_INCOME_SUM_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_F_BILL_INCOME_FC_M;
CREATE EXTERNAL TABLE NG3.TM_F_BILL_INCOME_FC_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_F_BOSS_ACCT_CHANGE_M;
CREATE EXTERNAL TABLE NG3.TM_F_BOSS_ACCT_CHANGE_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_F_BAD_DEBTS_ACCRUE_M;
CREATE EXTERNAL TABLE NG3.TM_F_BAD_DEBTS_ACCRUE_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_F_BAD_DEBTS_REBACK_M;
CREATE EXTERNAL TABLE NG3.TM_F_BAD_DEBTS_REBACK_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   DISTICT_NAM    STRING,
   USR_TYP_NAM    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NET_PLAN_CELL_M;
CREATE EXTERNAL TABLE NG3.TM_NET_PLAN_CELL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NET_NPLAN_ACTVCELL_M;
CREATE EXTERNAL TABLE NG3.TM_NET_NPLAN_ACTVCELL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NET_LCOVER_USR_ACTVCELL_M;
CREATE EXTERNAL TABLE NG3.TM_NET_LCOVER_USR_ACTVCELL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   USR_CNT    INT,
...
DROP TABLE IF EXISTS NG3.TM_NET_HCOVER_MATCH_NETEXCPT_M;
CREATE EXTERNAL TABLE NG3.TM_NET_HCOVER_MATCH_NETEXCPT_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   USR_CNT    INT,
   WHOLE_TD_KEEP_RATE    DECIMAL(24,4),
...
DROP TABLE IF EXISTS NG3.TM_NET_HCOVER_MATCH_NETOK_M;
CREATE EXTERNAL TABLE NG3.TM_NET_HCOVER_MATCH_NETOK_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   USR_CNT    INT,
   WHOLE_TD_KEEP_RATE    DECIMAL(24,4),
...
DROP TABLE IF EXISTS NG3.TM_NET_EXCPT_TDCELL_M;
CREATE EXTERNAL TABLE NG3.TM_NET_EXCPT_TDCELL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NET_NORM_TDCELL_M;
CREATE EXTERNAL TABLE NG3.TM_NET_NORM_TDCELL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NET_NPLAN_CELL_M;
CREATE EXTERNAL TABLE NG3.TM_NET_NPLAN_CELL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NET_PLAN_ACTVCELL_M;
CREATE EXTERNAL TABLE NG3.TM_NET_PLAN_ACTVCELL_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TR_IMEI_TAC_BAND;
CREATE EXTERNAL TABLE NG3.TR_IMEI_TAC_BAND (
   TAC    STRING,
   DATA_DT    INT,
   TAC_CNT    INT,
...
ALTER TABLE NG3.TR_IMEI_TAC_BAND ADD PARTITION (branch='GMCC');

DROP TABLE IF EXISTS NG3.TO_P_GCUST_M;
CREATE EXTERNAL TABLE NG3.TO_P_GCUST_M (
   STAT_MO    INT,
   CUST_ID    STRING,
   AREA_CD    STRING,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_CDR_TD_CNTC_CIRC_M;
CREATE EXTERNAL TABLE NG3.TW_CDR_TD_CNTC_CIRC_M (
   A_SWITCH_CD    STRING,
   USR_MOB_NBR    STRING,
   A_BRND_CD    SMALLINT,
   A_USR_TYP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TW_NB_WLAN_ACTV_USR_M;
CREATE EXTERNAL TABLE NG3.TW_NB_WLAN_ACTV_USR_M (
   USR_NBR    STRING,
   BRND_CD    SMALLINT,
   CALL_CNT    INT,
   CALL_DUR    INT,
...
DROP TABLE IF EXISTS NG3.TM_TDUSE_BUSI_MO;
CREATE EXTERNAL TABLE NG3.TM_TDUSE_BUSI_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   TD_DEBET_DUR    BIGINT,
...
DROP TABLE IF EXISTS NG3.TM_IUSR_DATA_MO;
CREATE EXTERNAL TABLE NG3.TM_IUSR_DATA_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_IDD_ROAM_DATABUSI_MO;
CREATE EXTERNAL TABLE NG3.TM_IDD_ROAM_DATABUSI_MO (
   TM_INTRVL_CD    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
   USR_TYP_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_ROAMOUT_BUSI_MO;
CREATE EXTERNAL TABLE NG3.TM_ROAMOUT_BUSI_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_OCS_PRE_SINGLE_SEPARATE_MO;
CREATE EXTERNAL TABLE NG3.TM_OCS_PRE_SINGLE_SEPARATE_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   PKG_TYP_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_LOCAL_ROAM_INF_MO;
CREATE EXTERNAL TABLE NG3.TM_LOCAL_ROAM_INF_MO (
   TM_INTRVL_CD    INT,
   ROAM_TYP_CD    SMALLINT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_IDD_TOLL_INF_MO;
CREATE EXTERNAL TABLE NG3.TM_IDD_TOLL_INF_MO (
   TM_INTRVL_CD    INT,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_TOLL_INF_MO;
CREATE EXTERNAL TABLE NG3.TM_TOLL_INF_MO (
   TM_INTRVL_CD    INT,
   TOLL_TYP_CD    SMALLINT,
   BRND_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_NEW_USR_ARPU_MOU_NET_MO;
CREATE EXTERNAL TABLE NG3.TM_NEW_USR_ARPU_MOU_NET_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   DIR_TYP_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TM_VAL10_USR_MO;
CREATE EXTERNAL TABLE NG3.TM_VAL10_USR_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_INTL_ROAM_OUT_MO;
CREATE EXTERNAL TABLE NG3.TM_INTL_ROAM_OUT_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   USR_CNT    INT,
...
DROP TABLE IF EXISTS NG3.TM_12593_USE_MO;
CREATE EXTERNAL TABLE NG3.TM_12593_USE_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   HR_IND    STRING,
...
DROP TABLE IF EXISTS NG3.TM_NEWBUSI_USR_MO;
CREATE EXTERNAL TABLE NG3.TM_NEWBUSI_USR_MO (
   TM_INTRVL_CD    INT,
   BRND_CD    SMALLINT,
   CMCC_BRANCH_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_TD_SMSMMS_AOA_BUSI_MO;
CREATE EXTERNAL TABLE NG3.TM_TD_SMSMMS_AOA_BUSI_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   SMSMMS_IND    SMALLINT,
   AOA_IND    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_GMCC_3G_BUSI_MO;
CREATE EXTERNAL TABLE NG3.TM_GMCC_3G_BUSI_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   ROAM_TYP_CD    SMALLINT,
   TOLL_TYP_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_AOA_CALLINFO_MO;
CREATE EXTERNAL TABLE NG3.TM_AOA_CALLINFO_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    INT,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_INTL_TOLL_BUSI_MO;
CREATE EXTERNAL TABLE NG3.TM_INTL_TOLL_BUSI_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   BRND_CD    SMALLINT,
   PKG_CD    SMALLINT,
...
DROP TABLE IF EXISTS NG3.TM_SZX_HKCARD_MO;
CREATE EXTERNAL TABLE NG3.TM_SZX_HKCARD_MO (
   TM_INTRVL_CD    INT,
   CMCC_BRANCH_CD    STRING,
   TOT_USR_CNT    INT,
   NEW_USR_CNT    INT,
...
DROP TABLE IF EXISTS NG3.TM_NB_GPRS_ROLLOVER_FLUX_M;
CREATE EXTERNAL TABLE NG3.TM_NB_GPRS_ROLLOVER_FLUX_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
   BASS_PRDCT_CD    STRING,
...
DROP TABLE IF EXISTS NG3.TM_FREE_TERM_OTH_M;
CREATE EXTERNAL TABLE NG3.TM_FREE_TERM_OTH_M (
   STAT_MO    INT,
   CMCC_BRANCH_CD    STRING,
